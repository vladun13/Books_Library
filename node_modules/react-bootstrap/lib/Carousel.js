...
function (_React$Component) {
  ...
  function Carousel(props, context) {
    ...
    _this.handleNext = function (e) {
      ...
      var count = ValidComponentChildren.count(_this.props.children);
    ...
    _this.handlePrev = function (e) {
      ...
      if (index < 0) {
        if (!wrap) return;
        index = ValidComponentChildren.count(_this.props.children) - 1;
      }
  ...
  Carousel.getDerivedStateFromProps = function getDerivedStateFromProps(nextProps, _ref) {
    ...
    if (nextProps.activeIndex !== previousActiveIndex) {
      var lastPossibleIndex = ValidComponentChildren.count(nextProps.children) - 1;
