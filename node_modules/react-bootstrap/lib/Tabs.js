...
var ValidComponentChildren = _interopRequireWildcard(require("./utils/ValidComponentChildren"));
...
var propTypes = {
   ...
   * @default {Fade}
   */
  transition: _propTypes.default.oneOfType([_propTypes.default.oneOf([false]), _elementType.default]),
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return _react.default.createElement(TabContainer, {
      ...
      role: "tablist",
      as: "nav"
    }), ValidComponentChildren.map(children, this.renderTab)), _react.default.createElement(_TabContent.default, null, ValidComponentChildren.map(children, function (child) {
