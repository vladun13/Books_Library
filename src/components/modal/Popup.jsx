          ...
          <div className="popup-overlay">
            <div className="popup-content">
              <form onSubmit={(e) => {e.preventDefault(); this.props.onSubmit({authors: this.state.author, publishedDate: this.state.publishedDate, title: this.state.title})}}>
                ...
                Date: <input type = "date" className="publDate" defaultValue={this.props.item.volumeInfo.publishedDate} onChange={e => this.setState({publishedDate: e.target.value }) } /> <br/>
